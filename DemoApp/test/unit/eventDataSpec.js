...
describe('eventData', function () {
    ...
    it('should issue a GET request to /data/event/11 when getEvent is called and the id is 11',
        inject(function (eventData, $httpBackend) { //httpBackend intercepts calls
    ...
    it('should set the id to 99 when save is called', inject(function (eventData, $httpBackend) {
